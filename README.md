<body>
  ...
  <p>⌊150r/2⌋ images are randomly selected from the unlabeled FHWS subset. An equal number of images are randomly selected from the unlabeled FSWH subset.</p>
  <p>Similarly, ⌈150(1-r)/2⌉ images are randomly selected from FHWH, and the same number from FSWS. Thus the unlabeled dataset always contains exactly 300 images (of the possible 600 in the full unlabeled dataset), no matter the mix rate.</p>
